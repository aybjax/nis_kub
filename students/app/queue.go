...
func (q *Queue) EnqueueTransformNotify(queueMsg *pbdto.DiffIds) error {
	...
	return q.client.Publish(msg, "student.to_modify", "")
}

func (q *Queue) TransformNotifyListener(cb func(context.Context, *pbdto.DiffIds) error) {
	q.client.Subscribe("student.to_modify", "STUDENT_TO_MODIFY_QUEUE", func(data []byte) error {
...
func (q *Queue) NotifyStudentChanged(_ context.Context, update *pbdto.UpdateEmbedded) error {
	...
	return q.client.Publish(bs, "student.modified", "")
}

func (q *Queue) CourseChangedListener(cb func(ctx context.Context, update *pbdto.UpdateEmbedded) error) {
