...
func NewMetricsMiddleware(next app.StudentService, requestCount metrics.Counter, requestLatency metrics.Histogram) app.StudentService {
...
func (mw *MetricsMiddleware) GetAll(ctx context.Context) (output []*pbdto.Student, err error) {
...
func (mw *MetricsMiddleware) Get(ctx context.Context, id string) (output *pbdto.Student, err error) {
	defer func(begin time.Time) {
...
func (mw *MetricsMiddleware) Post(ctx context.Context, payload *pbdto.Student) (id interface{}, err error) {
	defer func(begin time.Time) {
...
func (mw *MetricsMiddleware) Put(ctx context.Context, id string, payload *pbdto.Student) (newId interface{}, err error) {
	defer func(begin time.Time) {
...
func (mw *MetricsMiddleware) CourseModifiedListener(ctx context.Context, updateInfo *pbdto.UpdateEmbedded) (err error) {
	defer func(begin time.Time) {
	...
	mw.next.CourseModifiedListener(ctx, updateInfo)

	return
}

func (mw *MetricsMiddleware) StudentModifiedListener(ctx context.Context, diffIds *pbdto.DiffIds) (err error) {
	defer func(begin time.Time) {
	...
	mw.next.StudentModifiedListener(ctx, diffIds)
