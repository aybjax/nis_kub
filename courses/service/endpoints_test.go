...
func (t testService) GetAll(ctx context.Context) ([]*pbdto.Course, error) {
	return []*pbdto.Course{
		&pbdto.Course{
			Id: "GetAllId",
		},
...
func (t testService) Get(ctx context.Context, id string) (*pbdto.Course, error) {
	return &pbdto.Course{
		Id: "GetId",
	}, nil
}
...
func (t testService) Post(ctx context.Context, payload *pbdto.Course) (id interface{}, err error) {
	return "PostId", nil
}
func (t testService) Put(ctx context.Context, id string, payload *pbdto.Course) (newId interface{}, err error) {
	return "PutId", nil
}
func (t testService) Delete(ctx context.Context, id string) (oldId interface{}, err error) {
	return "DeleteId", nil
}
func (t testService) StudentModifiedListener(ctx context.Context, payload *pbdto.UpdateEmbedded) error {
	payload.Id = "CourseModifiedListenerId"

	return nil
}
func (t testService) CourseModifiedListener(ctx context.Context, payload *pbdto.DiffIds) error {
...
func TestMakeGetCoursesEndpoint(t *testing.T) {
	...
	result := resp.(*pbdto.CoursesResponse)
